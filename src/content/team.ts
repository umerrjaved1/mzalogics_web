...
export type TeamMember = {
  ...
  /** Portraits come from /public/media/team/{slug}.jpg; initials show until then. */
  initials: string;
  tone: string;
  location: string;
  experience: string;
