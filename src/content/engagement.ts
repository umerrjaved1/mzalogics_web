...
export const engagementModels = [
  {
    ...
    points: ["Fixed scope and price", "UI/UX included", "From $3,900 with AI"],
  },
  {
    title: "Growth",
    ...
    points: ["Custom features", "Integrations & CI/CD", "From $11,500 with AI"],
  },
  {
    title: "Enterprise",
    ...
    points: ["Dedicated pod", "Custom architecture", "From $28,000 with AI"],
  },
] as const;
