...
export function FloatingSocial() {
  return (
    <div className="fixed bottom-6 left-4 z-30 hidden flex-col gap-2 sm:flex">
      <a
        href={site.linkedin}
        target="_blank"
        rel="noreferrer"
        className="inline-flex items-center gap-2 rounded-full bg-navy py-2 pl-2.5 pr-3.5 text-[13px] font-medium text-white shadow-lg"
